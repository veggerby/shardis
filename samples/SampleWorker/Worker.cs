...
public class Worker(ILogger<Worker> logger, IShardStreamBroadcaster<string> broadcaster, IHostApplicationLifetime hostApplicationLifetime) : BackgroundService
{
    private readonly ILogger<Worker> _logger = logger;
    private readonly IShardStreamBroadcaster<string> _broadcaster = broadcaster;
