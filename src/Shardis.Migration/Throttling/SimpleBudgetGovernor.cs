...
/// <remarks>Creates a new <see cref="SimpleBudgetGovernor"/>.</remarks>
...
public sealed class SimpleBudgetGovernor(int initialGlobal = 256, int minGlobal = 32, int maxPerShard = 16) : IBudgetGovernor
{
    private readonly object _lock = new();
    private readonly Dictionary<string, ShardHealth> _latest = new();

    private int _globalBudget = initialGlobal;
    private readonly int _initialGlobal = initialGlobal;
    private readonly int _minGlobal = minGlobal;
    private readonly int _maxPerShard = maxPerShard;
