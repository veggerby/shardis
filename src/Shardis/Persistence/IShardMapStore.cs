...
/// </summary>
public interface IShardMapStore
{
    /// <summary>
    ...
    bool TryGetShardIdForKey(ShardKey shardKey, out ShardId shardId);
    ...
    ShardMap AssignShardToKey(ShardKey shardKey, ShardId shardId);
}
